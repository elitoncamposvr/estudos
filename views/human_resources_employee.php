<div class="content">
	...
	<div class="breadcrumb">
		<div>
			...
			<p>Recursos Humanos <i class="fas fa-angle-right fa-xs"></i> Funcionários</p>
		</div>
		<span>
	...
	<?php if ($employee_list) : ?>
		...
		<?php foreach ($employee_list as $e) : ?>
			<div class="table_data">
				...
				<div class="w-15 txt-center"><?php if($e['status'] == 1){ echo '<span class="info">Ativo</span>';} else { echo '<span class="info_danger">Inativo</span>';} ?></div>
