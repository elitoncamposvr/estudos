<div class="content">
	...
	<div class="breadcrumb">
		<div><i class="fas fa-cogs fa-lg icon"></i>
			<p>Configurações<i class="fas fa-angle-right fa-xs"></i>Usuários<i class="fas fa-angle-right fa-xs"></i>Permissões<i class="fas fa-angle-right fa-xs"></i>Adicionar Grupo</p>
		</div>
		<span>
			...
			<?php foreach ($permissions_list as $p) : ?>
				<div class="w-30 p-l m-s rounded-m bg_white mb-m">
					<label for="p_<?php echo $p['id']; ?>">
						<p class="bold"><input type="checkbox" name="permissions[]" value="<?php echo $p['id']; ?>" id="p_<?php echo $p['id']; ?>" /> <?php echo $p['permission_title']; ?></p><div class="rounded-m p-s mt-s bg_lt_gray"><?php echo $p['name']; ?></div>
					</label>
				</div>
			<?php endforeach; ?>
		</div>
