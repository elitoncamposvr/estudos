<div class="content">
    ...
    <div class="breadcrumb">
        <div><i class="fas fa-cogs fa-lg icon"></i>
            <p>Configurações<i class="fas fa-angle-right fa-xs"></i>Usuários<i class="fas fa-angle-right fa-xs"></i>Grupo de Permissões</p>
        </div>
        <span>
                ...
                <div class="dropdown">
                    ...
                    <div id="myDropdown1" class="dropdown-content">
                        <ul>
                            ...
                            <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>users/permissions_delete_group/<?php echo  $p['id']; ?>" onclick="return confirm('Deseja realmente excuir?')"><i class="fas fa-trash-alt"></i> Deletar</a></li>
                        </ul>
                    </div>
                </div>
            </div>
