<div class="content">
	...
	<div class="breadcrumb">
		<div><i class="fas fa-cogs fa-lg icon"></i>
			<p>Configurações<i class="fas fa-angle-right fa-xs"></i>Usuários<i class="fas fa-angle-right fa-xs"></i>Permissões</p>
		</div>
		<span>
	...
	<?php foreach ($permissions_list as $p) : ?>
		<div class="table_data">
			...
			<div class="w-10">
				<a href="<?php echo BASE_URL; ?>users/permissions_delete/<?php echo $p['id']; ?>" onclick="return confirm('Deseja realmente excuir?')" title="Excluir"><i class="fas fa-trash-alt fa-lg"></i></a>
			</div>
		</div>
	<?php endforeach; ?>
</div>