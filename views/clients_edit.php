...
<div class="breadcrumb">
	<div><i class="fas fa-users fa-lg icon"></i>
		<p>Clientes <i class="fas fa-angle-right fa-xs"></i> Editar</p>
	</div>
	<span>
...
<form method="POST">
	<div class="w-100 wrap my-s rounded-m">
		...
		<select class="my-s" name="client_type" id="client_type">
			<option value="1" id="cpf" <?php echo ($client_info['client_type'] == '1') ? 'selected="selected"' : ''; ?>>Pessoa Física</option>
			<option value="2" id="cnpj" <?php echo ($client_info['client_type'] == '2') ? 'selected="selected"' : ''; ?>>Pessoa Jurídica</option>
		</select>
	</div>
	<div class="fb-100">
		<div class="w-50 my-s wrap mr-m">
			<label for="name" class="cpf hide">Nome</label>
			<label for="name" class="cnpj hide">Razão Social</label>
			<input class="w-100" type="text" name="name" id="name" value="<?php echo $client_info['name']; ?>">
		</div>
		<div class="w-50 my-s wrap">
	...
	<div class="fb-100">
		<div class="w-35 my-s mr-m">
			...
			<input class="cpf w-100 hide" type="text" name="cpf" id="cpf" placeholder="CPF" value="<?php echo $client_info['cpf']; ?>">
			<input class="cnpj w-100 hide" type="text" name="cnpj" id="cnpj" placeholder="CNPJ" value="<?php echo $client_info['cnpj']; ?>">
		</div>
		<div class="w-35 my-s mr-m">
	...
	<div class="fb-100">
		<div class="w-35 my-s mr-m">
			...
			<input class="w-100" type="text" name="state_registration" id="state_registration" value="<?php echo $client_info['state_registration']; ?>">
		</div>
		<div class="w-35 my-s">
			<label for="limit_credit">Limite de Crédito</label>
			<input class="w-100" type="text" name="limit_credit" id="limit_credit" value="<?php echo number_format($client_info['limit_credit'], 2, ',', '.'); ?>">
		</div>
	</div>
	<div class="w-100">
