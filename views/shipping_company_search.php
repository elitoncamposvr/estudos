...
<?php else : ?>
        ...
        <div class="search_inventory">
            <form class="w-100" action="<?php echo BASE_URL; ?>shippingcompany/search">
                <p class="mb-l">Refaça sua pesquisa</p>
                <span class="mb-2"><input type="text" class="w-30 txt-center" name="sp" id="sp" placeholder="Pesquisar Transportadora" required></span>
