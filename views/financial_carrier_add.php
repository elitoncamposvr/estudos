<div class="content">
    ...
    <div class="breadcrumb">
        <div><i class="fas fa-cogs fa-lg icon"></i>
            <p>Configurações<i class="fas fa-angle-right fa-xs"></i>Financeiro<i class="fas fa-angle-right fa-xs"></i>Portador/Carteira<i class="fas fa-angle-right fa-xs"></i>Adicionar</p>
        </div>
        <span>
