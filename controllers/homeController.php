...
class homeController extends controller {
    ...
    public function index() {
        ...
        // $data['expenses'] = $s->getTotalExpenses(date('Y-m-d', strtotime('-30 days')), date('Y-m-d', strtotime('+1 day')), $u->getCompany());
        ...
        // $data['expenses_list'] = $s->getExpensesList(date('Y-m-d', strtotime('-30 days')), date('Y-m-d', strtotime('+1 day')), $u->getCompany());
